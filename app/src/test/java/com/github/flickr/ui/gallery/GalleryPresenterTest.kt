...
import com.github.flickr.utils.DataGenerator
import com.github.flickr.utils.rx.TestSchedulerProvider
...
class GalleryPresenterTest {
    ...
    fun loadNextPhotos_ItemsAvailable_refreshItems() {
        ...
        verify(mMockGalleryMvpView, times(2))?.showBottomButton()
        verify(mMockGalleryMvpView, times(2))?.hideBottomButton()
    ...
    fun loadNextPhotos_ItemsUnavailable_notRefreshItems() {
        ...
        verify(mMockGalleryMvpView)?.showBottomButton()
        verify(mMockGalleryMvpView)?.hideBottomButton()
